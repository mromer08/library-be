...
public class ReportServiceImpl implements ReportService {@Override
    public PagedResponseDTO<LoanResponseDTO> findLoansByDueDate(LocalDate date) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'findLoansByDueDate'");
    }

    @Override
    public PagedResponseDTO<LoanResponseDTO> findOverdueLoans() {
        // TODO Auto-generated method stub
    ...
    @Override
    public TopDegreeInLoansReportDTO findTopDegreeInLoans(LocalDate startDate, LocalDate endDate) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'findTopDegreeInLoans'");
    }

    @Override
    public OverduePayStudentReportDTO findOverduePaymentsByStudent(Student student, LocalDate startDate,
            LocalDate endDate) {
        // TODO Auto-generated method stub
    ...
    @Override
    public TopStudentLoansReportDTO findTopStudentInLoans(LocalDate startDate, LocalDate endDate) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'findTopStudentInLoans'");
    }

    @Override
    public PagedResponseDTO<BookResponseDTO> findBooksCurrentlyBorrowedByStudent(Student student) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'findBooksCurrentlyBorrowedByStudent'");
    }

    @Override
    public PagedResponseDTO<BookResponseDTO> findOutOfStockBooks() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'findOutOfStockBooks'");
    }

    @Override
    public PagedResponseDTO<BookResponseDTO> findNeverBorrowedBooks() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'findNeverBorrowedBooks'");
    }

    @Override
    public PagedResponseDTO<StudentResponseDTO> findSanctionedStudents() {
        // TODO Auto-generated method stub
